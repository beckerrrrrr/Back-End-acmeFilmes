            ...
            if(idFilme==''||idFilme==undefined||isNaN(idFilme))
                ...
                if(filme){
                    ...
                    if(filmeAtualizado){
                     ...
                     //mensagem de sucesso aos itens atualizados (nao finalizado ainda 
                     //falta algumaas mensagens de erros no final)
                        filmeAtualizadoJSON.status=
                        message.SUCCES_UPDATED_ITEM.status

                        filmeAtualizadoJSON.status_code=
                        message.SUCCES_UPDATED_ITEM.status_code

                        filmeAtualizadoJSON.message=
                        message.SUCCES_UPDATED_ITEM.message
...
const setExcluirFilme = async function() {
    ...
    try {
        ...
        else{ let comando=await filmeDAO.deleteFilme(idFilme)
            if(comando)
    ...
    } catch (error) {  return message.ERROR_INTERNAL_SERVER
    }
}
